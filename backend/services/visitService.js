...
const scanVisitQr = async (
    ...
    matchedVisit.qrScannedAt =
        new Date();

    matchedVisit.qrScannedBy =
        securityId;
    ...
    return {
        ...
        visitorEmail:
            matchedVisit.visitorEmail,
        visitorPhone:
            matchedVisit.visitorPhone,
        visitDate:
            matchedVisit.visitDate,
        visitStartTime:
            matchedVisit.visitStartTime,
        purpose:
            matchedVisit.purpose,
        status:
            matchedVisit.status,
        qrExpiresAt:
            matchedVisit.qrExpiresAt,
    };
};
